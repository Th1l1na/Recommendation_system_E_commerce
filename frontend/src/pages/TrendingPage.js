...
const TrendingPage = () => {
  ...
  useEffect(() => {
    const fetchTrendingProducts = async () => {
      try {
        const response = await axios.get("http://localhost:5000/trending"); // Adjust based on your API
        setTrendingProducts(response.data.trending_items); // Adjust based on your API response
      } catch (error) {
  ...
  return (
    <>
      ...
      <div className="min-h-screen p-4 bg-gray-200">
        <h1 className="mb-4 text-3xl font-bold">Trending Products</h1>
